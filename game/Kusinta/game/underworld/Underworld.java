...
public class Underworld {
	...
	Image platform1, platform2, platform3, platform4, platform5;
	...
	public Underworld(Factory factory, int width, int height, Model model) {
		...
		try {
			...
			platform1 = ImageLoader.loadImage(UnderworldParam.platformImage[0], 172);
			platform2 = ImageLoader.loadImage(UnderworldParam.platformImage[1], 86);
			platform3 = ImageLoader.loadImage(UnderworldParam.platformImage[2], 258);
			platform4 = ImageLoader.loadImage(UnderworldParam.platformImage[3], 344);
			platform5 = ImageLoader.loadImage(UnderworldParam.platformImage[4], 860);
		} catch (Exception e) {
