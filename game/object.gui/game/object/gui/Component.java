...
/**
 * Each component represents a surface, with a width and height. Each component
 * is at a location within its parent container. Each child is painted above its
 * parent, in terms of the z-order. Any surface of a child that is not within
 * its parent's surface is not visible and thus not selectable.
 * 
...
public class Component {
	 ...
	 * <code>x</code> and <code>y</code> are defined to be local to the coordinate
	 ...
	 * component should be painted; such as when the component is first being shown
	 * or some of its rendered pixels were damaged on the screen. The given graphics
	 * is clipped to the area that needs to be painted.
	 *
	...
	void doPaint(Graphics g) {
		...
		toGlobal(loc);
		Graphics newG = g.create(loc.x(), loc.y(), m_width, m_height);
		this.paint(newG);
		newG.dispose();
	 ...
	 * @param x
	 * @param y
	 * @return this component if the given local coordinates are within the bounds
	 *         of this component. Otherwise, returns null.
	 */
